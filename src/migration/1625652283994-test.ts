...
export class test1625652283994 implements MigrationInterface {
    name = 'test1625652283994'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query("CREATE TABLE `book` (`id` int NOT NULL AUTO_INCREMENT, `title` varchar(255) NOT NULL, `author` varchar(255) NOT NULL, `publish_at` datetime NOT NULL, PRIMARY KEY (`id`)) ENGINE=InnoDB");
